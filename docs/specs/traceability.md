...
| `REQ-UI-001` | `frontend-spec.md`, `visual-theme.md` | Existing `GET /api/tasks`, `GET /api/images`, `GET /api/settings`; future Top10 endpoints | `/` Home dashboard and normal image banner | `tests/stage/frontend_scaffold.sh` Home dashboard/banner wiring check |
| `REQ-UI-002` | `frontend-spec.md`, `api-contract.md` | `src/backend/src/api.rs` download endpoints | `/download` tabbed workbench | `req_ui_002_post_single_download_rejects_invalid_pixiv_id`, `tests/stage/frontend_scaffold.sh` Phase 7B download tabs anchor |
| `REQ-UI-003` | `frontend-spec.md`, `api-contract.md` | `src/backend/src/api.rs` task endpoints | `/tasks` recent list and task detail modal | `req_task_002_req_task_004_get_task_returns_items_and_logs`, `req_task_002_req_ui_003_get_tasks_returns_task_list`, `tests/stage/frontend_scaffold.sh` Phase 7B task modal anchors |
...
| `REQ-UI-005` | `frontend-spec.md`, `api-contract.md` | `src/backend/src/api.rs`, `src/backend/src/images/mod.rs`, future map endpoints | `/gallery` grid and right-side detail drawer | `req_img_002_req_ui_005_get_images_returns_gallery_metadata`, `tests/stage/frontend_scaffold.sh` Phase 7B gallery drawer anchor |
